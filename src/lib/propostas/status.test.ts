...
describe("Integridade de Status da Proposta", () => {
  it("todos os valores de PropostaStatus devem estar presentes em TRANSICOES", () => {
    const statuses: PropostaStatus[] = [
      "rascunho", "enviada_banco", "em_analise_credito", "credito_aprovado",
      "credito_recusado", "checklist_documentacao", "cadastro_complementar",
      "dossie_completo", "formularios", "envio_documentos_banco",
      "vistoria_agendamento", "vistoria_concluida", "emissao_contrato",
      "contrato_emitido", "erro_envio", "aguardando_envio", "cancelada",
  ...
  it("todos os status relevantes devem estar no MAPA do stepper", () => {
    const statuses: PropostaStatus[] = [
      "rascunho", "enviada_banco", "em_analise_credito", "credito_aprovado",
      "credito_recusado", "contrato_emitido", "erro_envio", "aguardando_envio",
      "cancelada", "aguardando_documentos", "engenharia_vistoria", "analise_juridica"
    ];
