...
export const Route = createFileRoute("/_authenticated/operacional/chats")({
  ...
  beforeLoad: () =>
    assertModuloPermitido("operacional.chats", ["operacional.demandas", "crm.clientes"]),
  head: () => ({
    meta: [
      { title: "Central de Conversas · Operacional" },
      {
        name: "description",
        content: "Todos os chats do sistema — colegas, clientes e demandas — em um único painel.",
      },
    ],
  }),
