  ...
  const exportarPDF = async () => {
    ...
    try {
      ...
      exportPDF(
        ...
        meta,
        [
          { label: "Com férias vencidas", value: String(ferias.data?.resumo.comFeriasVencidas ?? 0) },
          { label: "Vencem em 90 dias", value: String(ferias.data?.resumo.aVencer90 ?? 0) },
          { label: "Saldo de dias", value: String(ferias.data?.resumo.diasSaldoTotal ?? 0) },
          { label: "Provisão", value: brl(ferias.data?.resumo.provisaoTotal ?? 0) },
        ] as any,
        colunas,
        linhasFerias,
        "relatorio-ferias-clt",
