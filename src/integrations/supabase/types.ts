...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      ...
      conciliacao_resultado: "conferido" | "divergente" | "ausente_no_sistema" | "ausente_no_banco";
      ...
      regime_casamento:
        ...
        | "participacao_final"
        | "nao_aplicavel";
      rh_ferias_status: "planejada" | "aprovada" | "em_curso" | "concluida" | "cancelada";
      rh_folha_status: "aberta" | "conferida" | "fechada" | "cancelada";
      rh_lancamento_status: "previsto" | "descontado" | "pago" | "cancelado" | "recebido";
      rh_ocorrencia_tipo:
        | "falta"
        | "atestado"
        | "advertencia"
        ...
        | "elogio"
        | "outro";
      rh_status_funcionario: "ativo" | "experiencia" | "afastado" | "ferias" | "desligado";
      rh_tipo_contrato: "clt" | "pj" | "estagio" | "autonomo" | "temporario" | "aprendiz";
...
export const Constants = {
  public: {
    Enums: {
      ...
      conciliacao_resultado: ["conferido", "divergente", "ausente_no_sistema", "ausente_no_banco"],
      demanda_status: ["aberta", "em_andamento", "aguardando", "concluida", "cancelada"],
      doc_categoria: ["comprador", "conjuge", "vendedor", "imovel", "outros", "vendedor_conjuge"],
      doc_status: ["pendente", "recebido", "aprovado", "reprovado", "expirado"],
      escopo_dados: ["todos", "equipe", "proprios", "personalizado"],
      financial_categoria_tipo: ["despesa", "receita"],
      financial_recorrencia: ["nenhuma", "mensal", "anual", "parcelado"],
