        ...
        <Secao titulo="Dados pessoais">
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            ...
            {mostrarEstadoCivil && ESTADO_CIVIL_COM_REGIME.has(f.estado_civil) && (
              <SelSelect label="Regime de casamento (se aplicável)" value={f.regime_casamento} options={TIPO_REGIME_CASAMENTO} onChange={(v) => set({ regime_casamento: v })} className="sm:col-span-2" erro={err("regime_casamento")} />
            )}
          </div>
        </Secao>
      )}
